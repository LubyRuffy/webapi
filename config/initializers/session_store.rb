...
#Rails.application.config.session_store :active_record_store, :key => '_webapi_session', :expire_after => 60.minutes

#Rails.application.config.session_store ActionDispatch::Session::CacheStore, :expire_after => 60.minutes
Rails.application.config.session_store ActionDispatch::Session::CacheStore, :expire_in => 60.minutes
